...
namespace Estimate
{
    ...
    {
        { textBox1, "Supplier Code is required" },
        { textBox2, "Supplier Name is required" },
        ...
        //            string checkQuery = "SELECT COUNT(*) FROM Supplier WHERE SupplierName = @SupplierName AND ContactNo=@ContactNo";
        ...
        //            {
        //                checkCmd.Parameters.AddWithValue("@SupplierName", textBox2.Text);
        //                checkCmd.Parameters.AddWithValue("@ContactNo", formattedPrimaryContact);
        //                int count = (int)await checkCmd.ExecuteScalarAsync();

        //                if (count > 0)
        //                {
        //                    MessageBox.Show("An Supplier with this Mobile Number already exists. Please enter different details.", "Duplicate Entry", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        //                    return;
        //                }
        //            }
        ...
        //    INSERT INTO Supplier (Code, SupplierName, ContactNo, MobileNo, Email, CountryID, StateID,GSTTypeID,GSTAreaCode,GSTNumber,image,BnchID,LocID,CreatedBy,CreatedDate) 
        //    VALUES              (@Code, @SupplierName, @ContactNo, @MobileNo, @Email,  @CountryID, @StateID, @GSTTypeID,@GSTAreaCode,@GSTNumber,@image,@BnchID,@LocID,@CreatedBy,GETDATE());
        ...
        //                cmd.Parameters.AddWithValue("@GSTNumber", textBox4.Text);
...
WHERE ID = @ID";
                    ...
                    else // INSERT
                    {
                        ...
                        using (SqlCommand checkCmd = new SqlCommand(checkQuery, conn))
                        {
                            ...
                            if (count > 0)
                            {
                                MessageBox.Show("A Supplier with this Mobile Number already exists. Please enter different details.", "Duplicate Entry", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                return;
                            }
                        }
