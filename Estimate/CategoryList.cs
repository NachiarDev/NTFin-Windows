    ...
    public partial class CategoryList : Form
    {
        ...
        private void Loadcategorygrid()
        {
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("Usp_CategoryGetGrid", conn))
                    {
        ...
        private void DeleteFromDatabase(string id)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "DELETE FROM Category WHERE ID = @ID"; // Change table name properly
        ...
        {
            Category newForm = new Category(); // Create an instance of Form2
            newForm.ShowDialog();
        }
