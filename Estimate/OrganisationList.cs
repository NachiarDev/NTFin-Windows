...
namespace Estimate
{
    public partial class OrganisationList : Form
    {
        ...
        private void OrganisationList_Load(object sender, EventArgs e)
        {
            LoadOrganisationgrid();
            ...
            dataGridView1.Columns["Address1"].HeaderText = "Primary Address";
            dataGridView1.Columns["Address2"].HeaderText = "Alternate Address";
            ...
            dataGridView1.Columns["Name"].HeaderText = "Organisation Name";
            AddButtonColumns();
        ...
        private void LoadOrganisationgrid()
        {
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("Usp_OrganisationGetGrid", conn))
                    {
        ...
        private void DeleteFromDatabase(string id)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "DELETE FROM Organisation WHERE ID = @ID"; // Change table name properly
        ...
        {
            Organisation newForm = new Organisation(); // Create an instance of Form2
            newForm.ShowDialog();
        }
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                if (columnName == "Button1") // View button clicked
                {
                    ...
                    Organisation newForm = new Organisation();

                    // Set values into Organisation form controls
                    newForm.Controls["textBox6"].Text = selectedRow.Cells["ID"].Value?.ToString();
                    ...
                    newForm.Controls["textBox3"].Text = selectedRow.Cells["Email"].Value?.ToString();
                    newForm.Controls["richTextBox1"].Text = selectedRow.Cells["Address1"].Value?.ToString();
                    newForm.Controls["richTextBox2"].Text = selectedRow.Cells["Address2"].Value?.ToString();
                    newForm.Controls["textBox4"].Text = selectedRow.Cells["City"].Value?.ToString();
                    newForm.Controls["textBox5"].Text = selectedRow.Cells["Zip"].Value?.ToString();
