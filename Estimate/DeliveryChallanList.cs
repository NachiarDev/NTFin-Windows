...
namespace Estimate
{
    public partial class DeliveryChallanList : Form
    {
        ...
        private void DeliveryChallanList_Load(object sender, EventArgs e)
        {
            ...
            LoadDeliveryChallanlistgrid();
            dataGridView1.Columns["ID"].Visible = false;
            dataGridView1.Columns["Transaporttype"].Visible = false;
            dataGridView1.Columns["Customer"].Visible = false;

            dataGridView1.Columns["SName"].HeaderText = "Sender Name";
            dataGridView1.Columns["SContact"].HeaderText = "Sender Mobile";
            dataGridView1.Columns["SAddress"].HeaderText = "Sender Address";
            dataGridView1.Columns["SGSTIN"].HeaderText = "Sender GST";

            dataGridView1.Columns["RName"].HeaderText = "Receiver Name";
            dataGridView1.Columns["RContact"].HeaderText = "Receiver Mobile";

            dataGridView1.Columns["RAddress"].HeaderText = "Receiver Address";
            dataGridView1.Columns["RGSTIN"].HeaderText = "Receiver GST";

            dataGridView1.Columns["driverContact"].HeaderText = "DriverContact";
        ...
        private void LoadDeliveryChallanlistgrid()
        {
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("Usp_DeliveryChallanGetGrid", conn))
                    {
        ...
        private void DeleteFromDatabase(string id)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "DELETE FROM DeliveryChallan WHERE ID = @ID"; // Change table name properly
        ...
        {
            DeliveryChallan newForm = new DeliveryChallan(); // Create an instance of Form2
            newForm.ShowDialog();
        }
