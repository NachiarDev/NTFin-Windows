    ...
    public partial class SupplierList : Form
    {
        ...
        private void LoadSuppliergrid()
        {
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("Usp_SupplierGetGrid", conn))
                    {
        ...
        private void DeleteFromDatabase(string id)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "DELETE FROM Supplier WHERE ID = @ID"; // Change table name properly
        ...
        {
            Supplier newForm = new Supplier(); // Create an instance of Form2
            newForm.ShowDialog();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                if (columnName == "Button1") // View button clicked
                {
                    ...
                    newForm.Controls["textBox2"].Text = selectedRow.Cells["SupplierName"].Value?.ToString();
                    ...
                    newForm.Controls["textBox4"].Text = selectedRow.Cells["GSTNumber"].Value?.ToString();
                    ...
                    newForm.Shown += (s, args) =>
                    {
                        ...
                        if (newForm.Controls["comboBox3"] is ComboBox gsttypeCombo)
                        {
                            ...
                            using (SqlConnection con = new SqlConnection("Data Source=45.64.104.2;Initial Catalog=kalviaga_NTFin_Test;User ID=TestDBA;Password=N@tsys@2024;Encrypt=True;TrustServerCertificate=True;"))
                            {
                                ...
                                SqlDataAdapter da = new SqlDataAdapter("SELECT ID, GSTType FROM GSTType", con);
