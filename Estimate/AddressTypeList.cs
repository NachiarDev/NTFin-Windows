...
namespace Estimate
{
    public partial class AddressTypeList : Form
    {
        ...
        private void AddressTypeList_Load(object sender, EventArgs e)
        {
            Loadaddresstypegrid();
        ...
        private void DeleteFromDatabase(string id)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "DELETE FROM Tbl_AddressType WHERE ID = @ID"; // Change table name properly
        ...
        {
            AddressType newForm = new AddressType(); // Create an instance of Form2
            newForm.ShowDialog();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                if (columnName == "Button1")
                {
                    ...
                    AddressType newForm = new AddressType();

                    newForm.Controls["textBox2"].Text = selectedRow.Cells["ID"].Value?.ToString();
                    newForm.Controls["textBox1"].Text = selectedRow.Cells["AddressType"].Value?.ToString();
