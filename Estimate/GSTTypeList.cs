...
namespace Estimate
{
    public partial class GSTTypeList : Form
    {
        public GSTTypeList()
        {
            InitializeComponent();
        ...
        private void GSTTypeList_Load(object sender, EventArgs e)
        {
            Loadgsttypegrid();
        ...
        private void Loadgsttypegrid()
        {
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("Usp_GSTTypeGetGrid", conn))
                    {
        ...
        private void DeleteFromDatabase(string id)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "DELETE FROM Tbl_GSTType WHERE ID = @ID"; // Change table name properly
        ...
        {
            GSTTypeForm newForm = new GSTTypeForm(); // Create an instance of Form2
            newForm.ShowDialog();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                if (columnName == "Button1")
                {
                    ...
                    GSTTypeForm newForm = new GSTTypeForm();
