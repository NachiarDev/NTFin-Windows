...
namespace Estimate
{
    public partial class StateList : Form
    {
        public StateList()
        {
            InitializeComponent();
        ...
        private void StateList_Load(object sender, EventArgs e)
        {
        ...
        private void LoadCountrygrid()
        {
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("Usp_StateGetGrid", conn))
                    {
        ...
        private void DeleteFromDatabase(string id)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "DELETE FROM Tbl_State WHERE ID = @ID"; // Change table name properly
        ...
        {
            State newForm = new State(); // Create an instance of Form2
            newForm.ShowDialog();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                if (columnName == "Button1")
                {
                    ...
                    State newForm = new State();

                    newForm.Controls["textBox4"].Text = selectedRow.Cells["ID"].Value?.ToString();
                    newForm.Controls["textBox1"].Text = selectedRow.Cells["StateCode"].Value?.ToString();
                    newForm.Controls["textBox2"].Text = selectedRow.Cells["StateName"].Value?.ToString();
                    newForm.Controls["textBox3"].Text = selectedRow.Cells["GSTTIN"].Value?.ToString();
